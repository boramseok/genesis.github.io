window.addEventListener('DOMContentLoaded', function () {
    ...
    $('#section02 .tab > li').click(function () {

        let idx = $('#section02 .tab > li').index(this);

        $('#section02 .tab > li').removeClass('on');
        $('#section02 .tab > li').eq(idx).addClass('on');

        $('#section02 .content > div').removeClass('on');
        $('#section02 .content > div').eq(idx).addClass('on');
    ...
    $('.overlay .close, .overlay .btn-modal').click(function () {
